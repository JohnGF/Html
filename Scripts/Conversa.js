...
function abreConversa(nome){
    ...
    '<img '+ detalhes + 'id="more" src="Resources/more.png" height="60"/>  '+
    '</div><div id = "conversa">'+
    '<div id = "caixaConversa" class="scroll"></div>'+
    '<textarea placeholder="Escreva uma mensagem..." id="mensagemConversa" required></textarea>'+
    '<button type="submit" class="enviaMensagem" onclick="imprimeMensagem(`mensagemConversa`, `caixaConversa`)" style="height: 50px; width: 50px;"><img class="enviar" src="Resources/enviar.png"></button>'+
